...
class DocGenerator {
    ...
    _generateMarkdownModel() {
        ...
        lines.push(`*Generated with [PBIP Documenter](https://jonathanjihwankim.github.io/pbip-documenter/) — free browser tool for Power BI semantic model documentation (${totalMeasuresMd} measures documented on ${new Date().toLocaleDateString()})*`);
        lines.push(`*Saved you time? [Sponsor on GitHub ❤️](https://github.com/sponsors/JonathanJihwanKim?o=doc) · [Buy Me a Coffee ☕](https://buymeacoffee.com/jihwankim?o=doc)*`);
        lines.push('');
    ...
    _generateMarkdownVisuals(visualData) {
        ...
        lines.push('');
        lines.push(`*Generated with [PBIP Documenter](https://jonathanjihwankim.github.io/pbip-documenter/) — free browser tool for Power BI semantic model documentation (${new Date().toLocaleDateString()})*`);
        lines.push(`*Saved you time? [Sponsor on GitHub ❤️](https://github.com/sponsors/JonathanJihwanKim?o=doc) · [Buy Me a Coffee ☕](https://buymeacoffee.com/jihwankim?o=doc)*`);
        lines.push('');
